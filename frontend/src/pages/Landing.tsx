    ...
    <div className="flex flex-col min-h-screen">
      <header className="px-4 lg:px-6 h-16 flex items-center justify-between border-b">
        <a href="#" className="flex items-center justify-center">
          ...
          <span className="ml-2 text-2xl font-bold text-primary">Vichar</span>
        </a>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48 bg-gradient-to-r from-primary/10 via-primary/5 to-background">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              <Button className="transition-transform hover:scale-105 mt-6">Get Started</Button>
            </div>
          </div>
        </section>
...
//                   Vichar is the perfect platform for bloggers to express their ideas, connect with readers, and make an impact.
//                 </p>
//                 <p className="text-lg font-semibold text-primary mt-4  pt-4">
//                   Think, Write, Share – Vichar.
//                 </p>
//               </div>
//               <div className='pt-4'>
//               <Button className="transition-transform hover:scale-105 ">Get Started</Button>
//               </div>
//             </div>
//           </div>
//         </section>
...
//                 <Lightbulb className="h-12 w-12 text-primary mb-4" />
//                 <h3 className="text-xl font-bold mb-2">Inspire</h3>
//                 <p className="text-muted-foreground">Share your unique perspective and inspire others</p>
//               </div>
//               <div className="flex flex-col items-center text-center">
//                 <Users className="h-12 w-12 text-primary mb-4" />
//                 <h3 className="text-xl font-bold mb-2">Connect</h3>
//                 <p className="text-muted-foreground">Build a community around your content</p>
//               </div>
//               <div className="flex flex-col items-center text-center">
//                 <Zap className="h-12 w-12 text-primary mb-4" />
//                 <h3 className="text-xl font-bold mb-2">Grow</h3>
//                 <p className="text-muted-foreground">Expand your reach and grow your audience</p>
//               </div>
//               <div className="flex flex-col items-center text-center">
//                 <PenSquare className="h-12 w-12 text-primary mb-4" />
//                 <h3 className="text-xl font-bold mb-2">Create</h3>
//                 <p className="text-muted-foreground">Powerful tools to bring your ideas to life</p>
//               </div>
//             </div>
//           </div>
//         </section>
...
//         <section className="w-full py-12 md:py-24 lg:py-32">
//           <div className="container px-4 md:px-6">
//             <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-center mb-8">Explore Popular Categories</h2>
